...
var Config = /** @class */ (function () {
    ...
    function Config(options) {
        ...
        var moduleResolver = new TextLintModuleResolver({
         ...
         */
        this.rules = applyNormalizerToList(normalizeTextlintRuleKey, options.rules ? options.rules : defaultOptions.rules).filter(function (ruleName) {
         ...
         */
        this.filterRules = applyNormalizerToList(normalizeTextlintFilterRuleKey, options.filterRules ? options.filterRules : defaultOptions.filterRules).filter(function (ruleName) {
        ...
        var presetRulesConfig = loadRulesConfigFromPresets(this.presets, moduleResolver);
    ...
    Config.initWithAutoLoading = function (options) {
        ...
        var configRuleNamesObject = separateEnabledOrDisabled(configFileRaw.rules);
        var configFilterRuleNamesObject = separateEnabledOrDisabled(configFileRaw.filters);
        var configPresetNames = configRuleNamesObject.presetNames;
        var configFilePlugins = getPluginNames(configFileRaw);
        var configFilePluginConfig = getPluginConfig(configFileRaw);
        ...
        var configFileRulesConfig = createFlatRulesConfigFromRawRulesConfig(configFileRaw.rules);
        var configFileFilterRulesConfig = createFlatRulesConfigFromRawRulesConfig(configFileRaw.filters);
