...
- [Finding subdomains - Archiveteam](https://wiki.archiveteam.org/index.php/Finding_subdomains)
...
- [Exploit Observer | ARPSyndicate](https://www.exploit.observer/)

## Algebra Books

- [Introducing Geometric Algebra to Geometric Computing Software Developers: A Computational Thinking Approach | Abstract](https://arxiv.org/abs/1705.06668)
- [Peeter Joot's Blog » Geometric Algebra for Electrical Engineers.](https://peeterjoot.com/writing/geometric-algebra-for-electrical-engineers/)
