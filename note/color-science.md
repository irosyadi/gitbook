...
- [Color from Computer to Eyes](http://jamie-wong.com/post/color/)
- [Color](http://www.handprint.com/LS/CVS/color.html) License: [CC-ND, translation allowed](https://www.handprint.com/HP/WCL/faq.html)
...
- [Color FAQ](http://poynton.ca/ColorFAQ.html)
- [Color Online](https://sites.google.com/site/djcbriggs/colour-online)
- [Kay Web ](http://www1.icsi.berkeley.edu/~kay/)
...
- [rgbcmyk](http://rgbcmyk.com.ar)

## Color Format Converter
- [Colorizer](http://colorizer.org/) online color format converter
...
- [Gradient Picker](http://davidjohnstone.net/pages/lch-lab-colour-gradient-picker)
...
- [CSpace](http://davengrace.com/dave/cspace/) CIELAB to RGB
- [Colormine Convert](http://colormine.org/convert/) the most complete conversion
...
- [Excel](http://ccc.orgfree.com/)
- [Excel ](http://rgbcmyk.com.ar/en/xla-2/)
- [Formula](http://www.brucelindbloom.com/index.html?Math.html)
- [Color Calculator](http://www.brucelindbloom.com/index.html?ColorCalculator.html)
...
- [Colormine](http://colormine.org/color-converter), clamping if outside RGB gamut
...
- [I want Hue](http://medialab.github.io/iwanthue/) Good Site for Color Naming

## Color Naming
- [C0ffee](http://c0ffee.surge.sh/) Color name in leet code
- [Bada55](http://bada55.io/) Color name in leet code
- [CSS Words](http://thejacklawson.com/csswords/) Color name in leet code
...
- [Identify the closest web color name, name that color](http://chir.ag/projects/name-that-color)
...
- [Colord](http://colrd.com/color/)
- [Colour Lovers](https://www.colourlovers.com/colors)
- [Color Naming Models](http://vis.stanford.edu/papers/color-naming-models)
- [Color Names](http://vis.stanford.edu/color-names/)
...
- Problem of RGB: discontinuity of luminance, it is also not based on how the human eye perceive colors. See [here](http://hclwizard.org/why-hcl/) or [here](https://cscheid.github.io/lux/demos/hcl/hcl.html) or [example of the effect here](http://colorspace.r-forge.r-project.org/articles/endrainbow.html) and the [problem of rainbow color](https://eagereyes.org/basics/rainbow-color-map)
...
- [Colorspace](http://colorspace.r-forge.r-project.org/) with HCL, its [Python implmentation](https://python-colorspace.readthedocs.io/en/latest/hclcolorspace.html)
...
- [Theory of Color](http://medialab.github.io/iwanthue/theory/): If RGB fits to how screens produce colors, if CIE L*a*b* fits to how we perceive colors, HCL fits to how we think colors. It is like HSL, but perceptively unbiased. 
- [CIE Color Space](http://hyperphysics.phy-astr.gsu.edu/hbase/vision/cie.html), [chromaticity](http://hyperphysics.phy-astr.gsu.edu/hbase/vision/colper.html#c2)
